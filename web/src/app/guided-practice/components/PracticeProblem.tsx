...
interface PracticeProblemProps {
  problem: Problem;
  onAnswer: (problemId: string, answer: string, isCorrect: boolean, timeSpent: number) => void;
}

export default function PracticeProblem({ problem, onAnswer }: PracticeProblemProps) {
  ...
  return (
    <Card className="bg-background-highlight border-border">
      <CardHeader className="border-b border-border flex flex-row justify-between items-center">
        <CardTitle className="text-foreground font-serif">Question {problem.questionNumber}</CardTitle>
