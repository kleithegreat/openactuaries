...
export default function GuidedPracticePage() {
  ...
  const [sessionState, setSessionState] = useState<
    'loading' | 'selecting' | 'active' | 'summary' | 'error'
  >('loading');
  ...
  useEffect(() => {
    async function fetchUserData() {
      try {
        ...
        if (exams.length === 0) {
          setError(
            "You don't have any exams registered. Please set up your profile first.",
          );
  ...
  const startSession = async (examType: string) => {
    ...
    try {
      ...
      const problemCount =
        profileData.goalType === 'PROBLEMS' ? profileData.goalAmount : 10;
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-background-highlight p-6 rounded-xl border border-border">
            <h2 className="text-xl font-semibold mb-4">
              Which exam would you like to study for?
            </h2>
    ...
    <div className="min-h-screen bg-background p-6">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground">
              Guided Practice - Exam {selectedExam}
            </h1>
            <p className="text-foreground-secondary mt-1">
              Smart, personalized practice tailored to your needs
            </p>
