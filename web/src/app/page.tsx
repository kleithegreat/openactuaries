          ...
          <div className="pt-20 pb-16 sm:pt-28 sm:pb-24">
            <div className="text-center">
              ...
              <p className="text-lg text-foreground-secondary mb-12 leading-relaxed">
                Personalized practice problems for{' '}
                <strong className="text-foreground">P</strong>,{' '}
                <strong className="text-foreground">FM</strong>, and more coming
                soon.
                <span className="block mt-2">
                  Absolutely no strings attached, because exam prep
      ...
      <div className="py-20 bg-background">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center justify-center mb-6">
            ...
            <span className="ml-3 font-mono text-sm bg-foreground/5 px-3 py-1 rounded text-foreground-secondary">
              open-source
            </span>
          </div>
          ...
          <p className="text-foreground-secondary mb-8">
            open/actuaries aims to make actuarial education accessible to
            everyone. Created as a personal project to help fellow actuarial
            students, it&apos;s now available for everyone to use and contribute
            to.
          </p>
          <a
            href="https://github.com/kleithegreat/openactuaries"
