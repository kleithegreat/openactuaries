    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
      ...
      <div className="bg-primary/10 p-4 rounded-xl border border-primary/20 xl:col-span-3">
        ...
        <p className="text-foreground-secondary text-sm mt-1">
          Based on your performance data, your optimal study times appear to be{' '}
          <strong>early morning (5AM-9AM)</strong> and{' '}
          <strong>evening (6PM-10PM)</strong>. Consider scheduling your most
          challenging topics during these high-performance periods.
        </p>
      </div>
    </div>
  );
