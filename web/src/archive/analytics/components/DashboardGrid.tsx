  ...
  return (
    ...
    >
      <DragDropContext onDragEnd={handleDragEnd}>
        <div
          className="p-2 w-max"
          style={{ minWidth: '100%', minHeight: WIDGET_HEIGHT * 2 + 32 }}
        >
          <Droppable
              ...
              >
                {sortedWidgets.map((widget, index) => (
                  ...
                  >
                    {(provided, snapshot) => {
                      const isWide =
                        widget.size === 'wide' || widget.size === 'large';
                      const isTall =
                        widget.size === 'tall' || widget.size === 'large';
                          ...
                          >
                            <WidgetWrapper
                              ...
                              onUpdateSettings={settings =>
                                onUpdateSettings(widget.id, settings)
                              }
                              onUpdateSize={size =>
                                onUpdateWidgetSize(widget.id, size)
                              }
                            />
                          </div>
                        </div>
